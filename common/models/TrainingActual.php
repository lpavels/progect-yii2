...
/**
 * This is the model class for table "training_actual".
 *
 * @property int $id ID
 * @property int $kids_id Пользователь
 ...
 */
class TrainingActual extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['kids_id'], 'integer'],
            [['creat_at'], 'safe'],
            [['field1', 'field2', 'field3', 'field4', 'field5', 'field6', 'field7', 'field8', 'field9', 'field10', 'field11', 'field12', 'field13', 'field14'], 'default', 'value' => null],
            [['field1', 'field2', 'field3', 'field4', 'field5', 'field6', 'field7', 'field8', 'field9', 'field10', 'field11', 'field12', 'field13', 'field14'], 'string', 'max' => 150],
            [['field3', 'field4', 'field5', 'field6', 'field7', 'field8', 'field9', 'field10', 'field11', 'field12', 'field13', 'field14'], 'safe'],
        ];
    }
