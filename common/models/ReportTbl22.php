 ...
 * @property int|null change_name изменялось ФИО пользователем
 * @property int|null yearRegistration год регистрации
 * @property string $created_at
 * @property string|null $updated_at
 * @property string $created_ip
 * @property string|null $updated_ip
 */
class ReportTbl22 extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id','name', 'federal_district_id', 'region_id', 'municipality_id', 'organization_id', 'training_id', 'type_training', 'key_login', 'type_listener', 'created_ip'], 'required'],
            ...
            [['change_name','yearRegistration','created_at', 'updated_at'], 'safe'],
