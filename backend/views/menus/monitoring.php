...
$this->title = 'Мониторниг питания(7-11 лет)';
...
<?php $form = ActiveForm::begin([]); ?>
    ...
    <div class="container-fluid">
        <? if ($post){ ?>
            ...
            <? if (!Yii::$app->user->can('food_director')) { ?>
            <p><b>Количество муниципальных округов по данной выборке: <?=count($munics); ?></b></p>

            <p style="color: #7d3864; font-size: 22px;"><b>Общие данные о финансировании</b></p>
            <table class="table_th0 table-hover" style="width: 1440px!important;">
                <thead>
                <tr class="text-center"><? echo '<p class="mb-0" style="font-size: 20px; font-weight: 500;">'. $nutrition->name .'</p>'?></tr>
                <tr>
                    <?if($post['parent_id'] == 0) { ?>
                        <th class="text-center align-middle" rowspan="2" style="width: 340px!important;">Территория</th>
                    <?}else{?>
                        <th class="text-center align-middle" rowspan="2" style="width: 340px!important;">Образовательное учреждение</th>
                    <?}?>
                    <th class="text-center align-middle" colspan="2" style="width: 200px">Количество обучающихся 1-4 классов</th>
                    <th class="text-center align-middle" colspan="4" style="width: 270px">Общая планируемая сумма расходов на организацию питания школьников (в млн. руб)</th>
                    <th class="text-center align-middle" colspan="3" style="width: 270px">из них, на учебный 2020-2021 уч.год (млн. руб) в разрезе бюджетов</th>
                    <th class="text-center align-middle" colspan="3" style="width: 230px">Стоимость  питания на одного обучающегося в день (в руб)</th>
                </tr>
                <tr>
                    <th class="text-center align-middle">Всего</th>
                    <th class="text-center align-middle" style="width: 150px">Из них, обучается во вторую смену</th>
                    <th class="text-center align-middle">1 четв</th>
                    <th class="text-center align-middle">2 четв</th>
                    <th class="text-center align-middle">3 четв</th>
                    <th class="text-center align-middle">4 четв</th>
                    <th class="text-center align-middle">Федеральный</th>
                    <th class="text-center align-middle">Региональный</th>
                    <th class="text-center align-middle">Муниципальный</th>
                    <th class="text-center align-middle" style="width: 75px">горячие завтраки</th>
                    <th class="text-center align-middle" style="width: 75px">обеды</th>
                    <th class="text-center align-middle" style="width: 75px">горячие завтраки и обеды</th>
                </tr>
                </thead>
                <tbody>
                <?if($post['parent_id'] == 0) { ?>
                    <? foreach ($munics as $munic) { ?>
                        <?$mas_data = $menus_dishes_model->get_monitoring_common($munic->id, 'municipality');?>
                        <tr>
                            <td><?= $munic->name ?></td>
                            <td class="text-center"><?= $mas_data['quantity14']; ?></td>
                            <td class="text-center"><?= $mas_data['quantity14'] - $mas_data['quantity14_first']; ?></td>
                            <td class="text-center"><?= $mas_data['quarter1'] == 0 ? 'н/д' : $mas_data['quarter1']; ?></td>
                            <td class="text-center"><?= $mas_data['quarter2'] == 0 ? 'н/д' : $mas_data['quarter2']; ?></td>
                            <td class="text-center"><?= $mas_data['quarter3'] == 0 ? 'н/д' : $mas_data['quarter3']; ?></td>
                            <td class="text-center"><?= $mas_data['quarter4'] == 0 ? 'н/д' : $mas_data['quarter4']; ?></td>
                            <td class="text-center"><?= $mas_data['federal'] == 0 ? 'н/д' : $mas_data['federal']; ?></td>
                            <td class="text-center"><?= $mas_data['region'] == 0 ? 'н/д' : $mas_data['region']; ?></td>
                            <td class="text-center"><?= $mas_data['municipality'] == 0 ? 'н/д' : $mas_data['municipality']; ?></td>
                            <td class="text-center"><?= $mas_data['expenses_zavtrak'] == 0 ? 'н/д' : $mas_data['expenses_zavtrak']; ?></td>
                            <td class="text-center"><?= $mas_data['expenses_obed'] == 0 ? 'н/д' : $mas_data['expenses_obed']; ?></td>
                            <td class="text-center"><?= $mas_data['expenses_zavtrak_obed'] == 0 ? 'н/д' : $mas_data['expenses_zavtrak_obed']; ?></td>
                        </tr>
                        <?
                    }
                }else{
                    $mas_itog = $model->get_monitoring_common($post['parent_id'], 'municipality');
                    foreach($post_orgs as $organization){?>
                        <?$mas_data = $model->get_monitoring_common($organization->id, 'organization');?>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?
                                if($mas_data['federal'] != 0 && $mas_data['region'] != 0 && $mas_data['quarter1'] != 0 && $mas_data['quarter2'] != 0 && $mas_data['quarter3'] != 0 && $mas_data['quarter4'] != 0){
                                    if($mas_data['municipality'] != 0){
                                        echo $mas_data['municipality'];
                                    }
                                    else{
                                        $price = $mas_data['quarter1'] + $mas_data['quarter2'] + $mas_data['quarter3'] + $mas_data['quarter4'] - $mas_data['federal'] - $mas_data['region'];
                                        if($price <= 0 ){
                                            echo 'н/д';
                    ...
                    <tr class="table-danger">
                        <td class="" colspan="1">Итого по району:</td>
                        <td class="text-center"><?= $mas_itog['quantity14']; ?></td>
                        <td class="text-center"><?= $mas_itog['quantity14'] - $mas_itog['quantity14_first']; ?></td>
                        <td class="text-center"><?= $mas_itog['quarter1'] == 0 ? 'н/д' : $mas_itog['quarter1']; ?></td>
                        <td class="text-center"><?= $mas_itog['quarter2'] == 0 ? 'н/д' : $mas_itog['quarter2']; ?></td>
                        <td class="text-center"><?= $mas_itog['quarter3'] == 0 ? 'н/д' : $mas_itog['quarter3']; ?></td>
                        <td class="text-center"><?= $mas_itog['quarter4'] == 0 ? 'н/д' : $mas_itog['quarter4']; ?></td>
                        <td class="text-center"><?= $mas_itog['federal'] == 0 ? 'н/д' : $mas_itog['federal']; ?></td>
                        <td class="text-center"><?= $mas_itog['region'] == 0 ? 'н/д' : $mas_itog['region']; ?></td>
                        <td class="text-center"><?= $mas_itog['municipality'] == 0 ? 'н/д' : $mas_itog['municipality']; ?></td>
                        <td class="text-center"><?= $mas_itog['expenses_zavtrak'] == 0 ? 'н/д' : $mas_itog['expenses_zavtrak']; ?></td>
                        <td class="text-center"><?= $mas_itog['expenses_obed'] == 0 ? 'н/д' : $mas_itog['expenses_obed']; ?></td>
                        <td class="text-center"><?= $mas_itog['expenses_zavtrak_obed'] == 0 ? 'н/д' : $mas_itog['expenses_zavtrak_obed']; ?></td>
