...
<div class="report-rpn container">
    <div class="row">
        <div class="text-center"><h4>Отчёт по детям (дошк)</h4></div>
        <?php $form = ActiveForm::begin(); ?>

        <div class="col">
            <?= $form->field($model_report, 'report_federal_district')->dropDownList($district_item,
                [
        ...
        <div class="row">
            <div class="form-group" style="margin: 0 auto">
                <?= Html::submitButton('Посмотреть', ['value' => 'view', 'class' => 'mt-2 btn main-button-3 beforeload']) ?>
...
<?php if ($show == 1) { ?>
    <div class="rep-child table-responsive">
        <table class="table table-sm table-bordered table-hover text-center">
            ...
            {
                $imt_arr = $model_report->imt($item['mass'], $item['height'], $item['sex'], $item['age'], $item['field18'], $item['field19'],
                    $item['sleep_day'], $item['field17'], $item['charging'], $item['field2'], $item['walk'], $item['field15'],
                    $item['additional_education'], $item['field4'], $item['sports_section'], $item['sports_section1'], $item['field6'],
                    $item['sports_section2'], $item['field7'], $item['field8'], $item['field9'], $item['field20'], $item['field21'], $item['use_telephone'],
                    $item['menu_id']
                );
                $nutrition = $model_report->get_day_protein_vitamin_mineral($item['menu_id'], $item['age']);
                ?>
                <tr>
                    <td><?= $count++ ?></td>
                    ...
                    <td><?= $nutrition[36] ?></td>
                    <td><?= empty(!$nutrition[37]) ? round(100 / ($nutrition[37] / $imt_arr[5]) - 100, 1) : 0 ?></td>
