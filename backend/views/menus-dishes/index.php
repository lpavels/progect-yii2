...
$first_menu = Menus::find()->where(['user_id' => Yii::$app->user->id])->one();
...
?>
    <div class="menus-dishes-index">
        ...
        {
            $recipes_collections = RecipesCollection::find()->where(['organization_id' => [1, Yii::$app->user->identity->organization_id]])->all();
                ...
                <tr id="add_dish_<?php echo $nutrition->id ?>">
                    ...
                    <td colspan="1" class="text-center">
                        <?= Html::button('См. техкарту указанного блюда', [
                          ...
                          $.get("../menus-dishes/showtechmup?id=" + $(".dishes_id_" + $(this).attr("data-nutrition_id")).attr("data-dishes"), function(data){
                          $("#showTechmup .modal-body").empty();
                            $("#showTechmup .modal-body").append(data);
                            //console.log(data);
                            $("#showTechmup").modal("show");
